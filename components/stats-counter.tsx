    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <Card className="overflow-hidden border-2 border-primary/20">
        <CardContent className="p-0">
          <div className="bg-primary/10 p-6 flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold">{t('statsCounter.totalTimeInvested')}</h3>
              <div className="flex items-center mt-1 text-muted-foreground">
                <Clock className="h-4 w-4 mr-1" />
                <span className="text-sm">{t('statsCounter.acrossAllProjects')}</span>
              </div>
            </div>
      ...
      <Card className="overflow-hidden border-2 border-primary/20">
        <CardContent className="p-0">
          <div className="bg-primary/10 p-6 flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold">{t('statsCounter.totalInvestment')}</h3>
              <div className="flex items-center mt-1 text-muted-foreground">
                <DollarSign className="h-4 w-4 mr-1" />
                <span className="text-sm">{t('statsCounter.spentOnAiTools')}</span>
              </div>
            </div>
            <div className="h-12 w-12 bg-primary/20 rounded-full flex items-center justify-center">
      ...
      <Card className="overflow-hidden border-2 border-primary/20">
        <CardContent className="p-0">
          <div className="bg-primary/10 p-6 flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold">{t('statsCounter.totalRevenue')}</h3>
              <div className="flex items-center mt-1 text-muted-foreground">
                <PiggyBank className="h-4 w-4 mr-1" />
                <span className="text-sm">{t('statsCounter.generatedFromProjects')}</span>
              </div>
            </div>
            <div className="h-12 w-12 bg-primary/20 rounded-full flex items-center justify-center">
