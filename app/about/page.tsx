...
export default function AboutPage() {
  // Sample projects data with start dates
  const projects = [
    {
      id: 1,
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-primary/10 to-background">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-4 text-xl text-muted-foreground">
            The person behind AI Hypetrain and my journey with AI technologies
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="w-full md:w-2/3">
              ...
              <p className="text-lg text-muted-foreground mb-4">
                I'm a developer and DevOps professional with over 10 years of experience in the tech industry. In early
                2023, I became fascinated with the rapid advancements in AI and decided to document my journey exploring
                these tools.
              </p>
              <p className="text-lg text-muted-foreground mb-6">
                AI Hypetrain was born from my desire to provide transparent insights into the practical applications of
                AI technologies. I track the time invested, costs incurred, and any revenue generated from each
                experiment to give a realistic picture of the ROI for these tools.
              </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-muted/30">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card>
              <CardContent className="pt-6">
                <h3 className="text-xl font-bold mb-3">AI Technologies</h3>
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <div className="w-full bg-muted rounded-full h-4">
                  ...
                  <li className="flex items-center">
                    ...
                    <span className="ml-2 min-w-[4rem] text-right">Image Gen</span>
                  </li>
                  <li className="flex items-center">
                    <div className="w-full bg-muted rounded-full h-4">
                      <div className="bg-primary h-4 rounded-full" style={{ width: "75%" }}></div>
                    </div>
                    <span className="ml-2 min-w-[4rem] text-right">Voice AI</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-2 text-center">My AI Journey Timeline</h2>
          <p className="text-lg text-muted-foreground mb-12 text-center max-w-3xl mx-auto">
            A chronological view of all my AI experiments and projects
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-primary/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            I'm available for consulting and implementation projects related to AI technologies. Let's discuss how we
            can leverage AI to solve your business challenges.
          </p>
